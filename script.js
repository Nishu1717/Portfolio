...
// Typing effect for hero title with more personality
...
window.addEventListener('load', () => {
    ...
    // Add cursor blinking animation to CSS
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const heroTitle = document.querySelector('.hero h1');
    if (heroTitle) {
        heroTitle.innerHTML = heroTitle.innerHTML.replace('Hey there!', greeting);
    }
...
// Add some data-themed easter eggs
...
document.addEventListener('keydown', function(e) {
    if (e.keyCode === konamiCode[konamiIndex]) {
        ...
        if (konamiIndex === konamiCode.length) {
            showNotification('🎮 Konami Code activated! You\'re a true geek! 🤓', 'success');
